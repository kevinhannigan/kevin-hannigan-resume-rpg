...
import { personalProjects, type Project } from '@/data/projects';
      ...
      <div className="max-w-3xl mx-auto px-6 py-12">
        <header className="mb-12 text-center">
          ...
          <p className="text-sm text-[--gb-light] leading-relaxed opacity-80 max-w-xl mx-auto">
            Passion projects built outside of work — mobile apps, multiplayer
            games, data tools, and this site itself. Click any card to expand.
          </p>
        </header>
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center pt-12 mt-12 border-t border-[--gb-dark]">
          <Link href="/projects" className="gb-btn gb-btn-secondary">
            ← WORK PROJECTS
          </Link>
